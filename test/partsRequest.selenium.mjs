...
async function partsRequest() {
    ...
    const WAIT = 1000; // ms, how long to wait for the element to be located before throwing an error.
    const runs = 5;
    const times = [];
    let failures = 0;
    ...
    const id = "realfakeemailfortestingpurpose@gmail.com";       //test email and id      
